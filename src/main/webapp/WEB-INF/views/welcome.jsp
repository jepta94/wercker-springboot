...
<body>
    ...
    <div class="container">
      ...
      <div class="blueBannerHeading">
        <h1 class="blueBannerTitleWithSubtitle">
          <a style="color: #ff5777">Oracle Container Cloud Service + Wercker (Jepta)</a>
        </h1>
      </div>
  ...
  <div class="container serviceContainer" style="margin-top: 150px;">
    <div class="overviewLayout">
      <div>
              <br>SpringBoot application demo by Jepta (Step) Sinaga. Current server time: <%= new java.util.Date() %> <br>
              <br>
              <p>
